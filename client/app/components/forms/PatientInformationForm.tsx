  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div>
        ...
        <Input id="insurance-id" placeholder="Enter Insurance ID Number" className="h-10 py-2" />
      </div>
      <div>
        <label htmlFor="insurance-provider" className="block text-sm font-bold text-gray-700 mb-1">Insurance Provider</label>
        <Input id="insurance-provider" placeholder="Enter Insurance Provider" className="h-10 py-2" />
      </div>
      <div>
        <label htmlFor="payer" className="block text-sm font-bold text-gray-700 mb-1">Payer</label>
        <Input id="payer" placeholder="Enter Payer" className="h-10 py-2" />
      </div>
    </div>
  </div>
);
